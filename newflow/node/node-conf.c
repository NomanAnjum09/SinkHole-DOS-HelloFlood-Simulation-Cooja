...
/*----------------------------------------------------------------------------*/
  ...
  node_conf_init(void)
  {
    ...
    conf.K173713_period = _K173713_PERIOD; //assigning period time for our packet
...
/*----------------------------------------------------------------------------*/
  ...
  print_node_conf(void){
    ...
    PRINTF("[CFG]: - Network ID: %d\n[CFG]: - Beacon Period: %d\n[CFG]: - "
      "Report Period: %d\n[CFG]: - K173713 Period: %d\n[CFG]: - Rules TTL: %d\n[CFG]: - Min RSSI: "
      "%d\n[CFG]: - Packet TTL: %d\n[CFG]: - Next Hop -> Sink: ",
      conf.my_net, conf.beacon_period, conf.report_period,conf.K173713_period, //prining node_conf  info for our packet

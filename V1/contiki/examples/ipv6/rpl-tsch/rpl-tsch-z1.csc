...
<simconf>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.7405603810040515 0.0 0.0 1.7405603810040515 61.959801532080895 -38.57613415544754</viewport>
    </plugin_config>
    <width>236</width>
    <z>4</z>
    <height>230</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <filter>ID:8 TSCH-schedule: add_li</filter>
      <formatted_time />
      <coloring />
    </plugin_config>
    <width>1031</width>
  ...
  <plugin>
    ...
    <plugin_config>
      <notes>00:06.135	ID:2	TSCH-schedule: add_link 0 1 2 2 0 255
...
00:18.241	ID:2	TSCH: association done, sec 0, PAN ID abcd, asn-0.31b, jp 1, timeslot id 0, hopping id 0, slotframe len 0 with 0 links, from c1:0c:00:00:00:00:00:01
